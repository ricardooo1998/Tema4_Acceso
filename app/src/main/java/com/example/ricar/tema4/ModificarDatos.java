            ...
            q.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    for (DataSnapshot datasnapshot : dataSnapshot.getChildren())
                    {
                        ...
                        ddbb.child(clave).child(getString(R.string.nombre)).setValue(txtNombre);
                        ddbb.child(clave).child(getString(R.string.apellidos)).setValue(txtApellido);
                        ddbb.child(clave).child(getString(R.string.dirrecci_n)).setValue(txtDireccion);
                    }
                }
